...
import { _ as _sfc_main$1 } from './Card-B81ZNWgd.mjs';
import { _ as _sfc_main$2 } from './Badge-4IrPO892.mjs';
import { _ as __nuxt_component_2 } from './current-users-RximDFcn.mjs';
import { b as _sfc_main$a, a as __nuxt_component_5, k as _sfc_main$d } from './server.mjs';
import { _ as _sfc_main$3 } from './AvatarGroup-DdsBFRnx.mjs';
...
import { defineComponent, withAsyncContext, mergeProps, unref, withCtx, createVNode, toDisplayString, openBlock, createBlock, createCommentVNode, Fragment, renderList, createTextVNode, useSSRContext } from 'vue';
...
import 'node:crypto';
import 'consola';
import './Separator-s2cjcbon.mjs';
import './Table-WBkmfF0I.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UserAccountStatisticsChart = __nuxt_component_5;
      ...
      _push(ssrRenderComponent(_component_MyPage, mergeProps({ error: unref(error) }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (unref(data)) {
              _push2(`<div class="space-y-4"${_scopeId}><div class="${ssrRenderClass([
                "grid gap-4 md:grid-cols-2",
                unref(data).ownership === "joint" ? "lg:grid-cols-3" : "lg:grid-cols-[repeat(auto-fill,minmax(28rem,1fr))] xl:grid-cols-4"
              ])}"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_NuxtCard, { class: "bg-primary text-white" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(`<small${_scopeId2}>Total Balance</small></footer>`);
                  } else {
                    return [
                      ...
                      createVNode("footer", { class: "mt-2" }, [
                        ...
                        createVNode("small", null, "Total Balance")
                      ])
                    ];
                  }
                }),
              ...
              if (unref(data).ownership === "joint") {
                _push2(ssrRenderComponent(_component_NuxtCard, { class: "bg-success text-white" }, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<header${_scopeId2}><p class="card-title text-white"${_scopeId2}> Your Dividend: ${ssrInterpolate(unref(data)?.primaryUser?.ownership)}% </p></header><div class="mt-2 text-2xl font-semibold font-geist-mono"${_scopeId2}>${ssrInterpolate(("toDollar" in _ctx ? _ctx.toDollar : unref(toDollar))(
                        unref(data).balance * ((unref(data)?.primaryUser?.ownership ?? 100) / 100)
                      ))}</div><footer class="mt-2"${_scopeId2}>`);
                      _push3(ssrRenderComponent(_component_NuxtBadge, {
                        color: "neutral",
                        variant: "soft",
                      ...
                      return [
                        createVNode("header", null, [
                          createVNode("p", { class: "card-title text-white" }, " Your Dividend: " + toDisplayString(unref(data)?.primaryUser?.ownership) + "% ", 1)
                        ]),
                        createVNode("div", { class: "mt-2 text-2xl font-semibold font-geist-mono" }, toDisplayString(("toDollar" in _ctx ? _ctx.toDollar : unref(toDollar))(
                          unref(data).balance * ((unref(data)?.primaryUser?.ownership ?? 100) / 100)
                        )), 1),
                        createVNode("footer", { class: "mt-2" }, [
                          createVNode(_component_NuxtBadge, {
              ...
              if (unref(data).ownership === "joint") {
                _push2(ssrRenderComponent(_component_NuxtCard, null, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<header${_scopeId2}><p class="card-title"${_scopeId2}>Active Investments</p></header><div class="mt-2 text-2xl font-semibold font-geist-mono"${_scopeId2}>${ssrInterpolate(unref(data).activeInvestmentCount)}</div><footer class="mt-2"${_scopeId2}>`);
                      _push3(ssrRenderComponent(_component_NuxtBadge, {
                        color: "success",
                        variant: "soft",
                        class: "mr-2",
                      ...
                      _push3(`<small class="text-muted"${_scopeId2}>Financial Growth</small></footer>`);
                    } else {
                      return [
                        createVNode("header", null, [
                          createVNode("p", { class: "card-title" }, "Active Investments")
                        ]),
                        createVNode("div", { class: "mt-2 text-2xl font-semibold font-geist-mono" }, toDisplayString(unref(data).activeInvestmentCount), 1),
                        createVNode("footer", { class: "mt-2" }, [
                          createVNode(_component_NuxtBadge, {
                            color: "success",
                            variant: "soft",
                          ...
                          createVNode("small", { class: "text-muted" }, "Financial Growth")
                        ])
                      ];
                    }
                  }),
              ...
              _push2(ssrRenderComponent(_component_NuxtCard, null, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<header${_scopeId2}><p class="card-title"${_scopeId2}>Total Investment Profits</p></header><div class="mt-2 text-2xl font-semibold font-geist-mono"${_scopeId2}>${ssrInterpolate(("toDollar" in _ctx ? _ctx.toDollar : unref(toDollar))(unref(data).totalProfit))}</div><footer class="mt-2"${_scopeId2}>`);
                    _push3(ssrRenderComponent(_component_NuxtBadge, {
                      color: "success",
                      variant: "soft",
                      class: "mr-2",
                    ...
                    _push3(`<small class="text-muted"${_scopeId2}> From ${ssrInterpolate(unref(data).activeInvestmentCount)} active ${ssrInterpolate(unref(data).activeInvestmentCount === 1 ? "investment" : "investments")}</small></footer>`);
                  } else {
                    return [
                      createVNode("header", null, [
                        createVNode("p", { class: "card-title" }, "Total Investment Profits")
                      ]),
                      ...
                      createVNode("footer", { class: "mt-2" }, [
                        ...
                        createVNode("small", { class: "text-muted" }, " From " + toDisplayString(unref(data).activeInvestmentCount) + " active " + toDisplayString(unref(data).activeInvestmentCount === 1 ? "investment" : "investments"), 1)
                      ])
                    ];
                  }
                }),
              ...
              _push2(ssrRenderComponent(_component_NuxtCard, null, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(_component_UserFinancialAccountCurrentUsers, {
                      balance: unref(data).balance
                    }, null, _parent3, _scopeId2));
                  } else {
                    return [
                    ...
                    return [
                      createVNode("div", { class: "flex flex-col md:flex-row md:items-end justify-between gap-x-4 gap-y-6" }, [
                        createVNode("div", { class: "space-y-2" }, [
                          ...
                          createVNode("p", { class: "font-geist-mono text-lg font-medium" }, " Account Number: " + toDisplayString(unref(data).number), 1),
            ...
            return [
              unref(data) ? (openBlock(), createBlock("div", {
                ...
                createVNode("div", {
                  ...
                  unref(data).ownership === "joint" ? (openBlock(), createBlock(_component_NuxtCard, {
                    key: 0,
                  ...
                  unref(data).ownership === "joint" ? (openBlock(), createBlock(_component_NuxtCard, { key: 1 }, {
                    default: withCtx(() => [
                      createVNode("header", null, [
                        createVNode("p", { class: "card-title" }, "Active Investments")
                      ]),
...
//# sourceMappingURL=index-DS9B4tMZ.mjs.map
