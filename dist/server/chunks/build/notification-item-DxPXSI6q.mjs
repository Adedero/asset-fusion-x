...
import { _ as _sfc_main$2 } from './Checkbox-B9D0p2uY.mjs';
import { _ as _sfc_main$3 } from './Badge-4IrPO892.mjs';
import { g as useToast, d as _sfc_main$f, b as _sfc_main$a, h as _sfc_main$4 } from './server.mjs';
import { defineComponent, ref, watch, useTemplateRef, mergeProps, unref, withCtx, isRef, createVNode, openBlock, createBlock, createCommentVNode, toDisplayString, useSSRContext } from 'vue';
      ...
      _push(ssrRenderComponent(_component_NuxtCard, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<p class="font-semibold"${_scopeId}>${ssrInterpolate(__props.notification.title)}</p>`);
            if (__props.notification.bodyType === "string") {
              _push2(`<p${_scopeId}>${ssrInterpolate(__props.notification.body)}</p>`);
            } else {
              _push2(`<div${_scopeId}>${__props.notification.body ?? ""}</div>`);
            }
            ...
            _push2(`<p class="text-xs text-muted"${_scopeId}>${ssrInterpolate(unref(useDateFormat)(__props.notification.createdAt, "MMM DD, YYYY"))} at ${ssrInterpolate(unref(useDateFormat)(__props.notification.createdAt, "hh:mm aa"))}</p></div>`);
            if (!unref(checked)) {
              ...
              createVNode("div", { class: "flex gap-2 md:gap-4" }, [
                ...
                createVNode("div", { class: "flex-grow" }, [
                  createVNode("div", { class: "text-sm" }, [
                    !__props.notification.isRead ? (openBlock(), createBlock("div", {
                      key: 0,
                    ...
                    createVNode("p", { class: "font-semibold" }, toDisplayString(__props.notification.title), 1),
                    __props.notification.bodyType === "string" ? (openBlock(), createBlock("p", { key: 1 }, toDisplayString(__props.notification.body), 1)) : (openBlock(), createBlock("div", {
                      key: 2,
                      innerHTML: __props.notification.body
                    }, null, 8, ["innerHTML"])),
                    createVNode("footer", { class: "mt-2 flex items-center gap-4 justify-between" }, [
                      createVNode("div", { class: "flex items-center gap-1" }, [
                        ...
                        createVNode("p", { class: "text-xs text-muted" }, toDisplayString(unref(useDateFormat)(__props.notification.createdAt, "MMM DD, YYYY")) + " at " + toDisplayString(unref(useDateFormat)(__props.notification.createdAt, "hh:mm aa")), 1)
                      ]),
...
//# sourceMappingURL=notification-item-DxPXSI6q.mjs.map
