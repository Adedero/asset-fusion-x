import { _ as _sfc_main$a } from './Badge-4IrPO892.mjs';
import { b as _sfc_main$a$1, d as _sfc_main$f, c as useRuntimeConfig, n as navigateTo } from './server.mjs';
...
import { _ as __nuxt_component_0$2 } from './partner-list-_OC9bwj2.mjs';
import { _ as __nuxt_component_3$1 } from './app-logo-Bcn3dx_L.mjs';
import { _ as _export_sfc } from './_plugin-vue_export-helper-1tPrXgE0.mjs';
import { _ as __nuxt_component_0$3 } from './cta-banner-53MrbXjk.mjs';
import 'reka-ui';
import 'vue-router';
...
const _imports_0$3 = publicAssetsURL("/img/buildings.gif");
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!unref(authStore).user.value) {
        ...
        _push(ssrRenderComponent(_component_NuxtButton, {
          icon: "lucide:rocket",
          label: `Continue on ${unref(config).public.appName}`,
          size: "lg",
          class: "rounded-full text-white",
          onClick: () => ("navigateToDashboard" in _ctx ? _ctx.navigateToDashboard : unref(navigateToDashboard))(unref(authStore).user.value?.role)
        }, null, _parent));
      }
      _push(ssrRenderComponent(_component_NuxtButton, {
        to: "/about/story",
      ...
      _push(`</div></div><div class="grid"><img${ssrRenderAttr("src", _imports_0$3)} class="rounded-2xl"></div></div>`);
    };
  }
});
...
const _imports_0$2 = publicAssetsURL("/img/investment.gif");
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></div></div><div class="pt-4 pb-12 col-span-2"><div class="text-5xl"><h2>Investment Options</h2></div><div class="mt-6"><p class="text-slate-300"> Browse our carefully designed investment tracks. Choose what fits your goals — from low-risk growth to aggressive returns — and let us do the rest. </p></div><div class="mt-6"><img${ssrRenderAttr("src", _imports_0$2)} class="rounded-xl h-48 object-cover"></div></div></div>`);
    };
  }
});
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_MainPartnerList = __nuxt_component_0$2;
      ...
      const _component_MainCtaBanner = __nuxt_component_0$3;
...
//# sourceMappingURL=index-CQ3cKKU_.mjs.map
