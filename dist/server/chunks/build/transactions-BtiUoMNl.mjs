...
import { _ as _sfc_main$2 } from './Select-B7XOgiyO.mjs';
...
import { _ as _sfc_main$7 } from './Textarea-C-7xlD2J.mjs';
...
import { _ as _sfc_main$4 } from './Popover-DPNBU4IK.mjs';
import { _ as _sfc_main$5 } from './Separator-DNEwSKSk.mjs';
import { _ as _sfc_main$8 } from './Input-B1DxjQAN.mjs';
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtModal, mergeProps({
        ...
        title: `Manage ${_ctx.transaction.type} transaction`
      }, _attrs), {
        body: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (_ctx.transaction.type === "deposit" || _ctx.transaction.type === "withdrawal") {
              _push2(`<div${_scopeId}><div class="space-y-3"${_scopeId}><p class="text-center text-2xl font-semibold font-mono"${_scopeId}>${ssrInterpolate(("toDollar" in _ctx ? _ctx.toDollar : unref(toDollar))(_ctx.transaction.USDAmount))}</p><div class="flex-center"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_NuxtBadge, {
                label: `Current status: ${_ctx.transaction.status}`,
                color: "neutral",
                variant: "subtle"
            ...
            return [
              _ctx.transaction.type === "deposit" || _ctx.transaction.type === "withdrawal" ? (openBlock(), createBlock("div", { key: 0 }, [
                createVNode("div", { class: "space-y-3" }, [
                  createVNode("p", { class: "text-center text-2xl font-semibold font-mono" }, toDisplayString(("toDollar" in _ctx ? _ctx.toDollar : unref(toDollar))(_ctx.transaction.USDAmount)), 1),
                  ...
                  withDirectives(createVNode("div", null, [
                    ...
                    [
                      vShow,
                      _ctx.transaction.status === "pending" && unref(txn).status !== "pending"
                    ]
                  ]),
                                              ...
                                              if (txn.approvedAt) {
                                                _push7(ssrRenderComponent(_component_NuxtFormField, { label: "Approved At" }, {
                                                  default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                    if (_push8) {
                                                      _push8(ssrRenderComponent(_component_NuxtInput, {
                                                        value: unref(useDateFormat)(txn.approvedAt, "YYYY-MMM-DD hh:mm aa").value,
                                                        disabled: "",
                                                        class: "w-full"
                                                      }, null, _parent8, _scopeId7));
                                                    } else {
                                              ...
                                              if (txn.failedAt) {
                                                _push7(ssrRenderComponent(_component_NuxtFormField, { label: "Failed At" }, {
                                                  default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                    if (_push8) {
                                                      _push8(ssrRenderComponent(_component_NuxtInput, {
                                                        value: unref(useDateFormat)(txn.failedAt, "YYYY-MMM-DD hh:mm aa").value,
                                                        disabled: "",
                                                        class: "w-full"
                                                      }, null, _parent8, _scopeId7));
                                                    } else {
...
//# sourceMappingURL=transactions-BtiUoMNl.mjs.map
