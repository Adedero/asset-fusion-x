...
import { g as useAppConfig, A as omit, t as tv, f as useLocale, r as usePortal, v as isArrayOfArray, e as _sfc_main$d, j as _sfc_main$a, w as get, B as _sfc_main$8, C as pickLinkProps, D as _sfc_main$9 } from './server.mjs';
import { DropdownMenu } from 'reka-ui/namespaced';
import { _ as _sfc_main$2 } from './Kbd-B4jx-Km7.mjs';

const _sfc_main$1 = {
  __name: "NuxtDropdownMenuContent",
            ...
            ssrRenderVNode(_push2, createVNode(resolveDynamicComponent(__props.sub ? unref(DropdownMenu).SubContent : unref(DropdownMenu).Content), mergeProps({
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<div role="presentation" class="${ssrRenderClass(__props.ui.viewport({ class: props.ui?.viewport }))}"${_scopeId2}><!--[-->`);
                                  ...
                                  if (_push5) {
                                    _push5(ssrRenderComponent(_sfc_main$8, mergeProps({ ref_for: true }, unref(pickLinkProps)(item), { custom: "" }), {
                                      default: withCtx(({ active, ...slotProps }, _push6, _parent6, _scopeId5) => {
                                        if (_push6) {
                                          _push6(ssrRenderComponent(_sfc_main$9, mergeProps({ ref_for: true }, slotProps, {
                  ...
                  return [
                    ...
                    createVNode("div", {
                      role: "presentation",
                      class: __props.ui.viewport({ class: props.ui?.viewport })
                    }, [
...
//# sourceMappingURL=DropdownMenu-j3t5Akwl.mjs.map
