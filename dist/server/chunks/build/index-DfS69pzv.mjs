import { h as useToast, c as _sfc_main$a, i as _sfc_main$4, e as _sfc_main$g } from './server.mjs';
import { _ as _sfc_main$1 } from './Checkbox-U0HjhKnj.mjs';
import { _ as _sfc_main$2 } from './DropdownMenu-41OxzaeK.mjs';
import { _ as _sfc_main$3 } from './Tooltip-bRrdFo0M.mjs';
import { _ as __nuxt_component_5 } from './notification-item-D2TIkCD_.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><div class="space-y-4"><header class="flex items-center gap-4 justify-between"><div class="text-xl font-semibold">Notifications</div>`);
      ...
      _push(`</header><div class="max-h-[calc(100dvh-10rem)] overlow-y-auto space-y-4">`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/user/notifications/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-DfS69pzv.mjs.map
