...
import { a7 as upperFirst } from '../nitro/nitro.mjs';
...
import { f as useLocale, g as useAppConfig, t as tv } from './server.mjs';
            ...
            if (unref(tableApi).getRowModel().rows?.length) {
              ...
              ssrRenderList(unref(tableApi).getRowModel().rows, (row) => {
                _push2(`<!--[--><tr${ssrRenderAttr("data-selected", row.getIsSelected())}${ssrRenderAttr("data-selectable", !!props.onSelect)}${ssrRenderAttr("data-expanded", row.getIsExpanded())}${ssrRenderAttr("role", props.onSelect ? "button" : void 0)}${ssrRenderAttr("tabindex", props.onSelect ? 0 : void 0)} class="${ssrRenderClass(ui.value.tr({
                  class: [
                    props.ui?.tr,
                    typeof unref(tableApi).options.meta?.class?.tr === "function" ? unref(tableApi).options.meta.class.tr(row) : unref(tableApi).options.meta?.class?.tr
                  ]
                }))}"${_scopeId}><!--[-->`);
              ...
              _push2(`<tr${_scopeId}><td${ssrRenderAttr("colspan", columns.value?.length)} class="${ssrRenderClass(ui.value.loading({ class: props.ui?.loading }))}"${_scopeId}>`);
              ssrRenderSlot(_ctx.$slots, "loading", {}, null, _push2, _parent2, _scopeId);
              _push2(`</td></tr>`);
            } else {
              _push2(`<tr${_scopeId}><td${ssrRenderAttr("colspan", columns.value?.length)} class="${ssrRenderClass(ui.value.empty({ class: props.ui?.empty }))}"${_scopeId}>`);
...
//# sourceMappingURL=Table-Bs0dxICt.mjs.map
