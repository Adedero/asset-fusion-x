import { _ as _sfc_main$1 } from './DropdownMenu-DBhK5Yjb.mjs';
import { e as useToast, f as _sfc_main$4, a as _sfc_main$a } from './server.mjs';
...
import { defineComponent, ref, computed, unref, withCtx, createVNode, openBlock, createBlock, toDisplayString, isRef, createCommentVNode, useSSRContext } from 'vue';
        ...
        ssrRenderSlot(_ctx.$slots, "default", { user: unref(user) }, () => {
          ...
          _push(ssrRenderComponent(_component_NuxtDropdownMenu, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div class="cursor-pointer rounded-full bg-accented text-muted overflow-hidden *:transition-transform hover:*:scale-120" style="${ssrRenderStyle({ width: __props.size, height: __props.size })}"${_scopeId}>`);
                if (!unref(user).image) {
                  _push2(`<div class="w-full h-full flex-center text-2xl p-4 font-semibold uppercase" style="${ssrRenderStyle({ fontSize: __props.fontSize })}"${_scopeId}>${ssrInterpolate(("initials" in _ctx ? _ctx.initials : unref(initials))(unref(user).name ?? ""))}</div>`);
                } else {
                ...
                return [
                  createVNode("div", {
                    ...
                    !unref(user).image ? (openBlock(), createBlock("div", {
                      ...
                      style: { fontSize: __props.fontSize }
      ...
      _push(ssrRenderComponent(_component_NuxtModal, {
        ...
        body: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_NuxtFieldGroup, { class: "w-full" }, {
...
//# sourceMappingURL=image-changer-CZ4xFY-5.mjs.map
