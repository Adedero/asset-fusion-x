...
import { g as useAppConfig, t as tv, N as avatarGroupInjectionKey, j as _sfc_main$c } from './server.mjs';
      ...
      _push(ssrRenderComponent(unref(Primitive), mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              hiddenCount.value > 0 ? (openBlock(), createBlock(_sfc_main$c, {
                key: 0,
                text: `+${hiddenCount.value}`,
                class: ui.value.base({ class: props.ui?.base })
...
//# sourceMappingURL=AvatarGroup-ULLiZpfq.mjs.map
