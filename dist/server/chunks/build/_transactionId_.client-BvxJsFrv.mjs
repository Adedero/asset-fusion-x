...
import { _ as _sfc_main$1 } from './Badge-4IrPO892.mjs';
import { _ as _sfc_main$2 } from './Separator-s2cjcbon.mjs';
import { b as _sfc_main$a, c as useRuntimeConfig } from './server.mjs';
import { t as toDollar } from './to-dollar-DdS_9tlH.mjs';
import { defineComponent, withAsyncContext, useTemplateRef, mergeProps, unref, withCtx, openBlock, createBlock, createVNode, toDisplayString, createCommentVNode, createTextVNode, useSSRContext } from 'vue';
                  ...
                  createVNode("div", {
                    ...
                    createVNode("div", { class: "space-y-2 *:p-1 text-[0.9rem]" }, [
                      createVNode("div", { class: "flex justify-between gap-4" }, [
                        ...
                        createVNode("span", { class: "capitalize text-right" }, toDisplayString(unref(transaction).initiator?.user?.name ?? "N/A: Transaction automated"), 1)
                      ]),
                      createVNode("div", { class: "flex justify-between gap-4" }, [
...
//# sourceMappingURL=_transactionId_.client-BvxJsFrv.mjs.map
