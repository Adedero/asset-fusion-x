import { _ as __nuxt_component_0, a as __nuxt_component_11 } from './color-mode-toggler-BNV7tZY6.mjs';
import { defineComponent, ref, withAsyncContext, withCtx, isRef, unref, createVNode, openBlock, createBlock, createCommentVNode, toDisplayString, useSlots, computed, mergeProps, renderSlot, createTextVNode, Fragment, renderList, toRef, toHandlers, useSSRContext } from 'vue';
...
import { Q as useRoute, S as useRouter, k as __nuxt_component_12, f as _sfc_main$4, a as _sfc_main$a, E as _sfc_main$e, n as navigateTo, i as _sfc_main$d, b as _sfc_main$f, l as __nuxt_component_2$1, g as authClient, c as useLocale, d as useAppConfig, t as tv, K as _sfc_main$b, L as pickLinkProps, M as _sfc_main$c, D as get, u as useRuntimeConfig, T as __nuxt_component_1$1, B as usePortal } from './server.mjs';
import { _ as __nuxt_component_3 } from './app-logo-Bcn3dx_L.mjs';
import { _ as _sfc_main$6 } from './NavigationMenu-CEek_Rvi.mjs';
import { _ as _sfc_main$5 } from './DropdownMenu-DBhK5Yjb.mjs';
...
import 'node:crypto';
import 'consola';
import './Badge-Cc8D9XvB.mjs';
import './Popover-Dbz4gcbf.mjs';
import 'reka-ui/namespaced';
import './Tooltip-DezAoIQv.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtSlideover, {
        ...
        body: withCtx(({ close }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ssrRenderSlot(_ctx.$slots, "content", { close }, null, _push2, _parent2, _scopeId);
          } else {
            return [
              renderSlot(_ctx.$slots, "content", { close })
            ];
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderList(__props.items, (item, index) => {
              ...
              _push2(ssrRenderComponent(_sfc_main$b, mergeProps({ ref_for: true }, unref(pickLinkProps)(item), { custom: "" }), {
                default: withCtx(({ active, ...slotProps }, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(_sfc_main$c, mergeProps({ ref_for: true }, slotProps, {
                      as: "span",
                ...
                (openBlock(true), createBlock(Fragment, null, renderList(__props.items, (item, index) => {
                  return openBlock(), createBlock(Fragment, { key: index }, [
                    createVNode("li", {
                      ...
                      createVNode(_sfc_main$b, mergeProps({ ref_for: true }, unref(pickLinkProps)(item), { custom: "" }), {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    function links$2(close) {
      if (authStore.user.value?.role === "admin") {
        return links({ signOut: () => open.value = true, close });
      }
      return links$1({ signOut: () => open.value = true, close });
    }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_NuxtChip = _sfc_main$e;
      const _component_NuxtButton = _sfc_main$a;
      ...
      _push(ssrRenderComponent(_component_NuxtLoadingIndicator, { color: "var(--ui-primary-color)" }, null, _parent));
      _push(ssrRenderComponent(_component_NuxtSidebar, null, {
        ...
        "body-header": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="w-full h-full flex items-center gap-2 justify-end"${_scopeId}><div${_scopeId}>`);
            ...
            _push2(ssrRenderComponent(_component_NuxtButton, {
              ...
              label: "Exit",
              size: "sm",
              "trailing-icon": "lucide:circle-arrow-left"
            }, null, _parent2, _scopeId));
            _push2(`</div>`);
            _push2(ssrRenderComponent(_component_NuxtDropdownMenu, {
              items: unref(secondaryLinks)({
            ...
            return [
              createVNode("div", { class: "flex items-center gap-1 justify-between overflow-x-auto" }, [
                ...
                createVNode("div", { class: "w-full h-full flex items-center gap-2 justify-end" }, [
                  createVNode("div", null, [
...
//# sourceMappingURL=user-CTg2AuWA.mjs.map
