...
import { _ as _sfc_main$2 } from './FieldGroup-CARSobbR.mjs';
import { a as _sfc_main$a, e as useToast, f as _sfc_main$4$1 } from './server.mjs';
import { _ as _sfc_main$3 } from './Input-D-obAiG7.mjs';
import { _ as _sfc_main$4 } from './Select-xAvxLs4-.mjs';
...
import { _ as _sfc_main$5 } from './Badge-Cc8D9XvB.mjs';
import { _ as __nuxt_component_11 } from './simple-paginator-BzPX9la4.mjs';
import { _ as _sfc_main$6 } from './FormField-BuvMUjfY.mjs';
import { _ as _sfc_main$7 } from './Separator-DwcB_Qjm.mjs';
import { defineComponent, ref, computed, withAsyncContext, mergeProps, unref, withCtx, isRef, createVNode, createTextVNode, toDisplayString, openBlock, createBlock, Fragment, renderList, createCommentVNode, useModel, mergeModels, useSSRContext } from 'vue';
        ...
        body: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_NuxtInput, {
                    readonly: "",
                    value: __props.profile.financialAccountName,
                    class: "w-full"
            ...
            _push2(ssrRenderComponent(_component_NuxtFormField, { label: "Business Created On" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_NuxtInput, {
                    readonly: "",
                    value: `${__props.profile.creationMonth}, ${__props.profile.creationYear}`,
                    class: "w-full"
                  }, null, _parent3, _scopeId2));
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_NuxtFormField, { label: "Business Certificate" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (__props.profile.certificate) {
                    _push3(`<a${ssrRenderAttr("href", __props.profile.certificate)} download${_scopeId2}>`);
                  ...
                  return [
                    __props.profile.certificate ? (openBlock(), createBlock("a", {
                      key: 0,
                      href: __props.profile.certificate,
                      download: ""
                    }, [
            ...
            _push2(ssrRenderComponent(_component_NuxtFormField, { label: "Proof of Address" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (__props.profile.proofOfAddress) {
                    _push3(`<a${ssrRenderAttr("href", __props.profile.proofOfAddress)} download${_scopeId2}>`);
                    _push3(ssrRenderComponent(_component_NuxtButton, {
                      label: "Download",
                      "trailing-icon": "lucide:download",
                      color: "neutral",
                  ...
                  return [
                    __props.profile.proofOfAddress ? (openBlock(), createBlock("a", {
                      key: 0,
                      href: __props.profile.proofOfAddress,
                      download: ""
                    }, [
                      createVNode(_component_NuxtButton, {
                        label: "Download",
            ...
            _push2(ssrRenderComponent(_component_NuxtButton, {
              label: "Submit",
              disabled: unref(approved) === __props.profile.approved,
              "loading-auto": "",
...
//# sourceMappingURL=business-profiles-CbByIioh.mjs.map
