...
import { _ as _sfc_main$3 } from './Collapsible-C4VUWcvT.mjs';
...
import { defineComponent, withAsyncContext, mergeProps, unref, withCtx, createVNode, openBlock, createBlock, Fragment, renderList, toDisplayString, createCommentVNode, useSSRContext } from 'vue';
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtModal, mergeProps({
        title: __props.status === "accepted" ? "Accept request" : "Reject request",
        dismissible: false
      }, _attrs), {
...
//# sourceMappingURL=requests-Fwf46V8k.mjs.map
