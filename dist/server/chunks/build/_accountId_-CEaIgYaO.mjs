...
import { _ as __nuxt_component_0$1 } from './navbar-Bc4duh39.mjs';
import { m as __nuxt_component_12, h as _sfc_main$4, b as _sfc_main$a } from './server.mjs';
import { defineComponent, withAsyncContext, computed, provide, ref, mergeProps, unref, withCtx, isRef, createVNode, openBlock, createBlock, toDisplayString, createCommentVNode, useSSRContext } from 'vue';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_NuxtNavbar = __nuxt_component_0$1;
      ...
      _push(ssrRenderComponent(_component_MyPage, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (unref(data)) {
              _push2(`<div class="h-full"${_scopeId}><header class="flex flex-wrap gap-x-4 gap-y-1"${_scopeId}><h1 class="text-3xl font-semibold"${_scopeId}>${ssrInterpolate(unref(data).name)}</h1><div class="space-x-2"${_scopeId}>`);
            ...
            return [
              unref(data) ? (openBlock(), createBlock("div", {
                ...
                createVNode("header", { class: "flex flex-wrap gap-x-4 gap-y-1" }, [
                  createVNode("h1", { class: "text-3xl font-semibold" }, toDisplayString(unref(data).name), 1),
...
//# sourceMappingURL=_accountId_-CEaIgYaO.mjs.map
