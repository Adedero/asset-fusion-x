import { c as _sfc_main$a } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-full select-none" }, _attrs))}><div class="w-full flex items-center justify-center gap-2 bg-default p-2 rounded-lg">`);
      ...
      if (__props.rows && __props.length) {
        _push(`<div class="text-center flex-shrink-0 py-1 px-2"><span class="font-medium">${ssrInterpolate(page.value * __props.rows + 1)}</span> to <span class="font-medium">${ssrInterpolate(Math.min((page.value + 1) * __props.rows, __props.length))}</span></div>`);
      } else {
        _push(`<!---->`);
      }
      ...
      _push(ssrRenderComponent(_component_NuxtButton, {
        ...
        disabled: __props.allLoaded || __props.totalPages !== void 0 && page.value >= __props.totalPages - 1,
        color: "neutral",
        variant: "outline",
...
//# sourceMappingURL=simple-paginator-BuVvJljo.mjs.map
