...
import { _ as __nuxt_component_14 } from './fetch-error-alert-Bcg5pKlj.mjs';
import { _ as _sfc_main$2 } from './Card-HL6icAYQ.mjs';
import { _ as _sfc_main$3 } from './Badge-Bsp85-Tk.mjs';
...
import { _ as _sfc_main$4 } from './Table-EFWxTa0Z.mjs';
import { _ as _sfc_main$5 } from './Calendar-DVJtNdgV.mjs';
import { e as _sfc_main$g, c as _sfc_main$a } from './server.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const { data, error, refresh, pending } = useFetch("/api/admin/overview", "$9JSQzB9jLA");
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data, error, refresh } = ([__temp, __restore] = withAsyncContext(() => useFetch("/api/user/pages/dashboard", {
      key: "user-dashboard"
    }, "$VDG7u31OJo")), __temp = await __temp, __restore(), __temp);
...
//# sourceMappingURL=index-gslNJ-Sq.mjs.map
