...
import { _ as _sfc_main$2 } from './Card-B81ZNWgd.mjs';
import { _ as _sfc_main$3 } from './Badge-4IrPO892.mjs';
import { defineComponent, withAsyncContext, mergeProps, unref, withCtx, createVNode, toDisplayString, openBlock, createBlock, createCommentVNode, Fragment, renderList, useSSRContext } from 'vue';
...
import { _ as _sfc_main$4 } from './Table-DuArEqHD.mjs';
import { _ as _sfc_main$5 } from './Calendar-zkeH78iI.mjs';
import { d as _sfc_main$f, b as _sfc_main$a } from './server.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><p class="text-sm text-muted font-semibold mb-2">Site Overview</p>`);
      if (unref(pending)) {
        ...
        _push(`<div class="grid gap-4 md:grid-cols-[repeat(auto-fit,minmax(250px,1fr))]">`);
        _push(ssrRenderComponent(_component_NuxtCard, null, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<header${_scopeId}><p class="card-title"${_scopeId}>Users</p></header><div class="mt-2 text-2xl font-semibold font-geist-mono"${_scopeId}>${ssrInterpolate(unref(data).users)}</div><footer class="mt-2"${_scopeId}>`);
              ...
              return [
                createVNode("header", null, [
                  createVNode("p", { class: "card-title" }, "Users")
                ]),
                createVNode("div", { class: "mt-2 text-2xl font-semibold font-geist-mono" }, toDisplayString(unref(data).users), 1),
        ...
        _push(ssrRenderComponent(_component_NuxtCard, null, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<header${_scopeId}><p class="card-title"${_scopeId}>Pending Transactions</p></header><div class="mt-2 text-2xl font-semibold font-geist-mono"${_scopeId}>${ssrInterpolate(unref(data).pendingTransactions)}</div><footer class="mt-2"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_NuxtBadge, {
                color: "error",
                variant: "soft",
                class: "mr-2",
              ...
              return [
                createVNode("header", null, [
                  createVNode("p", { class: "card-title" }, "Pending Transactions")
                ]),
                createVNode("div", { class: "mt-2 text-2xl font-semibold font-geist-mono" }, toDisplayString(unref(data).pendingTransactions), 1),
                createVNode("footer", { class: "mt-2" }, [
                  createVNode(_component_NuxtBadge, {
                    color: "error",
                    variant: "soft",
        ...
        _push(ssrRenderComponent(_component_NuxtCard, null, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<header${_scopeId}><p class="card-title"${_scopeId}>Financial Accounts</p></header><div class="mt-2 text-2xl font-semibold font-geist-mono"${_scopeId}>${ssrInterpolate(unref(data).financialAccounts)}</div><footer class="mt-2"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_NuxtBadge, {
                color: "success",
                variant: "soft",
                class: "mr-2",
              ...
              return [
                createVNode("header", null, [
                  createVNode("p", { class: "card-title" }, "Financial Accounts")
                ]),
                createVNode("div", { class: "mt-2 text-2xl font-semibold font-geist-mono" }, toDisplayString(unref(data).financialAccounts), 1),
                createVNode("footer", { class: "mt-2" }, [
                  createVNode(_component_NuxtBadge, {
                    color: "success",
                    variant: "soft",
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/admin/site-overview.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const __nuxt_component_1 = Object.assign(_sfc_main$1, { __name: "AdminSiteOverview" });
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_AdminSiteOverview = __nuxt_component_1;
      const _component_NuxtCard = _sfc_main$2;
      const _component_NuxtBadge = _sfc_main$3;
      const _component_EmptyIcon = __nuxt_component_6;
      const _component_NuxtTable = _sfc_main$4;
      const _component_NuxtCalendar = _sfc_main$5;
      ...
      _push(ssrRenderComponent(_component_MyPage, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (unref(data)) {
              _push2(`<div class="w-full lg:h-full gap-4 lg:flex pb-4"${_scopeId}><div class="w-full lg:min-w-0 lg:h-full lg:overflow-y-auto lg:flex-grow"${_scopeId}><div class="w-full max-h-full space-y-4 p-0.5"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_AdminSiteOverview, null, null, _parent2, _scopeId));
              _push2(`<div${_scopeId}><p class="text-sm text-muted font-semibold mb-2"${_scopeId}>Your Account</p><div class="grid gap-4 md:grid-cols-[repeat(auto-fit,minmax(250px,1fr))]"${_scopeId}>`);
              ...
              _push2(`</div></div><div class="w-full py-0.5"${_scopeId}>`);
              ...
              unref(data) ? (openBlock(), createBlock("div", {
                ...
                createVNode("div", { class: "w-full lg:min-w-0 lg:h-full lg:overflow-y-auto lg:flex-grow" }, [
                  createVNode("div", { class: "w-full max-h-full space-y-4 p-0.5" }, [
                    createVNode(_component_AdminSiteOverview),
                    createVNode("div", null, [
                      createVNode("p", { class: "text-sm text-muted font-semibold mb-2" }, "Your Account"),
...
//# sourceMappingURL=index-bVzxDlVb.mjs.map
