import { defineComponent, withAsyncContext, computed, ref, useModel, watch, mergeProps, unref, isRef, mergeModels, withCtx, renderSlot, useSlots, useId, createVNode, resolveDynamicComponent, createTextVNode, toDisplayString, openBlock, createBlock, createCommentVNode, Fragment, renderList, useSSRContext } from 'vue';
...
import { b as _sfc_main$a, f as useAppConfig, t as tv, l as useFormField, A as get } from './server.mjs';
import { _ as _sfc_main$3 } from './Alert-9mK7K0n2.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  props: /* @__PURE__ */ mergeModels({
    ...
    onlyDepositCurrencies: { type: Boolean, default: false }
  }, {
  ...
  async setup(__props) {
    ...
    const items = computed(() => {
      ...
      if (__props.onlyDepositCurrencies && !__props.onlyWithdrawalCurrencies) {
        filtered = filtered.filter((currency2) => currency2.allowDeposit === true);
      } else if (!__props.onlyDepositCurrencies && __props.onlyWithdrawalCurrencies) {
        filtered = filtered.filter((currency2) => currency2.allowWithdrawal === true);
      } else if (__props.onlyDepositCurrencies && __props.onlyWithdrawalCurrencies) {
        filtered = filtered.filter(
          (currency2) => currency2.allowDeposit === true && currency2.allowWithdrawal === true
        );
      }
      const formatted = filtered ? filtered.map((currency2) => ({
...
//# sourceMappingURL=currency-select-WFn2jBAH.mjs.map
