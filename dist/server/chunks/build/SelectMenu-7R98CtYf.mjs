...
import { f as useLocale, g as useAppConfig, r as usePortal, s as useFormField, k as useButtonGroup, l as useComponentIcons, t as tv, v as isArrayOfArray, w as get, y as compare, e as _sfc_main$d, j as _sfc_main$a, x as _sfc_main$b } from './server.mjs';
import { _ as _sfc_main$1 } from './Input-BtIiAvs7.mjs';
                                                  ...
                                                  renderSlot(_ctx.$slots, "item", {
                                                    ...
                                                    renderSlot(_ctx.$slots, "item-leading", {
                                                      ...
                                                      isSelectItem(item) && item.icon ? (openBlock(), createBlock(_sfc_main$d, {
                                                        ...
                                                        class: ui.value.itemLeadingAvatar({ class: [props.ui?.itemLeadingAvatar, item.ui?.itemLeadingAvatar] })
                                                      }), null, 16, ["size", "class"])) : isSelectItem(item) && item.chip ? (openBlock(), createBlock(_sfc_main$b, mergeProps({
                                                        key: 2,
                                                        size: props.ui?.itemLeadingChipSize || ui.value.itemLeadingChipSize(),
                                                        inset: "",
                                                        standalone: ""
...
//# sourceMappingURL=SelectMenu-7R98CtYf.mjs.map
