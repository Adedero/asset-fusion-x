...
import { R as useRoute, T as useRouter, _ as __nuxt_component_0$1, d as _sfc_main$f } from './server.mjs';
import { _ as _sfc_main$1 } from './Card-B81ZNWgd.mjs';
import { _ as _sfc_main$2 } from './Badge-4IrPO892.mjs';
import { _ as _sfc_main$3 } from './Pagination-CC-YpOuk.mjs';
...
import { defineComponent, computed, withAsyncContext, mergeProps, unref, withCtx, createVNode, toDisplayString, isRef, openBlock, createBlock, Fragment, renderList, createCommentVNode, useSSRContext } from 'vue';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const {
      ...
      `/api/user/financial-accounts/${accountId}/transactions`,
      {
        query
      },
      "$lvDJpg8l9N"
...
//# sourceMappingURL=index-DnpboNi8.mjs.map
