  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: __props.buttonHref || "/sign-up"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<button class="${ssrRenderClass([unref(classes).button, "cursor-pointer pointer-events-none rounded-full font-medium px-6 py-3 flex items-center gap-2 transition-colors"])}"${_scopeId}><p${_scopeId}>${ssrInterpolate(__props.buttonLabel || "Create Account")}</p>`);
            ...
            return [
              createVNode("button", {
                ...
                createVNode("p", null, toDisplayString(__props.buttonLabel || "Create Account"), 1),
...
//# sourceMappingURL=cta-banner-CKcKwBM_.mjs.map
