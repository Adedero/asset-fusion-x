import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, mergeModels, useModel, computed, unref, mergeProps, withCtx, renderSlot, createVNode, createBlock, createCommentVNode, openBlock, createTextVNode, toDisplayString, toRef, isRef, hasInjectionContext, inject, shallowRef, getCurrentInstance, provide, cloneVNode, h, createElementBlock, resolveComponent, useSlots, ref, resolveDynamicComponent, toHandlers, watch, Suspense, toValue, onServerPrefetch, useAttrs, shallowReactive, Fragment, nextTick, defineAsyncComponent, useSSRContext, createApp, renderList, useId, onErrorCaptured, reactive, effectScope, isReadonly, isShallow, isReactive, toRaw, withModifiers, getCurrentScope, markRaw } from 'vue';
import { N as serialize, O as defu, P as isEqual, c as createError$1, Q as parseQuery, R as klona, S as defuFn, I as hasProtocol, T as isScriptProtocol, K as joinURL, U as withQuery, V as sanitizeStatusCode, W as getContext, X as withTrailingSlash, Y as withoutTrailingSlash, Z as withLeadingSlash, _ as parseURL, $ as $fetch$1, a0 as baseURL, a1 as createHooks, a2 as executeAsync, a3 as encodeParam, a4 as encodePath, a5 as toRouteMatcher, a6 as createRouter$1 } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    ...
    component: () => import('./index-B0oHkUND.mjs')
  },
  {
    name: "user",
    path: "/user",
    meta: __nuxt_page_meta$Y || {},
    component: () => import('./index-CstqCqep.mjs')
  },
  {
    name: "admin",
    path: "/admin",
    meta: __nuxt_page_meta$X || {},
    component: () => import('./index-gslNJ-Sq.mjs')
  },
  {
    name: "admin-users",
    path: "/admin/users",
    meta: __nuxt_page_meta$W || {},
    component: () => import('./users-BqNxHktK.mjs')
  },
  {
    name: "contact",
    path: "/contact",
  ...
  },
  {
    ...
    component: () => import('./kyc-data-DwX6tcIK.mjs')
  },
  {
    name: "admin-settings",
    path: "/admin/settings",
    meta: __nuxt_page_meta$U || {},
    component: () => import('./settings-p62Cprjt.mjs')
  },
  {
    name: "admin-currencies",
    path: "/admin/currencies",
    meta: __nuxt_page_meta$T || {},
    component: () => import('./currencies-HVSESdip.mjs')
  },
  {
    name: "about-story",
    path: "/about/story",
    meta: __nuxt_page_meta$S || {},
    component: () => import('./story-zmoNkcxe.mjs')
  },
  {
    name: "admin-transactions",
    path: "/admin/transactions",
    meta: __nuxt_page_meta$R || {},
    component: () => import('./transactions-BmSA-IiU.mjs')
  },
  {
    name: "user-contact",
    path: "/user/contact",
  ...
  },
  {
    ...
    path: "/user/profile",
    component: () => import('./index-DFpiETI5.mjs'),
    children: [
      {
        name: "user-profile-index-kyc",
        path: "kyc",
        meta: __nuxt_page_meta$P || {},
        component: () => import('./kyc-CGGqbMAq.mjs')
      },
      {
        name: "",
        path: "",
        meta: __nuxt_page_meta$O || {},
        component: () => import('./index-CR61z7vz.mjs')
      }
    ]
  },
  {
    ...
    component: () => import('./index-B_aBV20u.mjs'),
    children: [
      {
        name: "user-accounts-index",
        path: "",
        component: () => import('./index-DUwG_zVF.mjs')
      },
      {
        name: "user-accounts-index-join-requests",
        path: "join-requests",
        component: () => import('./join-requests-CBJ2Kjls.mjs')
      }
    ]
  },
  {
    ...
    component: () => import('./index-Dj_72ZFE.mjs')
  },
  {
    name: "sign-up",
    path: "/sign-up",
    meta: __nuxt_page_meta$K || {},
    component: () => import('./index-ChohbH8X.mjs')
  },
  {
    name: "about-careers",
    path: "/about/careers",
    meta: __nuxt_page_meta$J || {},
    component: () => import('./careers-BnOesGGL.mjs')
  },
  {
    name: "about-mission",
    path: "/about/mission",
    meta: __nuxt_page_meta$I || {},
    component: () => import('./mission-C02w4grq.mjs')
  },
  {
    name: "impact-reviews",
    path: "/impact/reviews",
    meta: __nuxt_page_meta$H || {},
    component: () => import('./reviews-B3z1Qiwc.mjs')
  },
  {
  ...
  },
  {
    ...
    meta: __nuxt_page_meta$l || {},
    component: () => import('./_accountId_-Cr7hUHYv.mjs'),
    children: [
      {
        name: "user-accounts-accountId",
        path: "",
        component: () => import('./index-2qexCTfZ.mjs')
      },
      {
        name: "user-accounts-accountId-deposit",
        path: "deposit",
        meta: __nuxt_page_meta$u || {},
        component: () => import('./deposit-CcvAFpFE.mjs')
      },
      {
        name: "user-accounts-accountId-requests",
        path: "requests",
        component: () => import('./requests-B9A3xpqz.mjs')
      },
      {
        name: "user-accounts-accountId-settings",
        path: "settings",
        component: () => import('./settings-BffP6aEX.mjs')
      },
      {
      ...
      },
      {
        ...
        path: "withdraw",
        meta: __nuxt_page_meta$s || {},
        component: () => import('./withdraw-2uioN_68.mjs')
      },
      {
        name: "user-accounts-accountId-documents",
        path: "documents",
        meta: __nuxt_page_meta$r || {},
        component: () => import('./documents-BzkaBemS.mjs')
      },
      {
        name: "user-accounts-accountId-account-users",
        path: "account-users",
        meta: __nuxt_page_meta$q || {},
        component: () => import('./account-users-aBqUfYQJ.mjs')
      },
      {
        name: "user-accounts-accountId-notifications",
        path: "notifications",
        meta: __nuxt_page_meta$p || {},
        component: () => import('./notifications-C5t5FEpu.mjs')
      },
      {
        name: "user-accounts-accountId-business-profile",
        path: "business-profile",
        component: () => import('./business-profile-DwotRqC1.mjs')
      },
      {
        name: "user-accounts-accountId-investments",
        path: "investments",
        meta: __nuxt_page_meta$o || {},
        component: () => import('./index-CNFp8ebM.mjs')
      },
      {
        name: "user-accounts-accountId-transactions",
        path: "transactions",
        meta: __nuxt_page_meta$n || {},
        component: () => import('./index-BJpi1d2z.mjs')
      },
      {
        name: "user-accounts-accountId-investments-investmentId",
        path: "investments/:investmentId()",
        meta: __nuxt_page_meta$m || {},
        component: () => import('./_investmentId_-CvzCjrUM.mjs')
      },
      {
        name: "user-accounts-accountId-transactions-transactionId",
        path: "transactions/:transactionId()",
        component: () => createClientPage(() => import('./_transactionId_.client-CRQf4tvf.mjs'))
      }
    ]
  },
  {
    ...
    meta: __nuxt_page_meta$k || {},
    component: () => import('./track-record-BrLJHqAG.mjs')
  },
  {
    name: "user-change-password",
    path: "/user/change-password",
    meta: __nuxt_page_meta$j || {},
    component: () => import('./index-DbWZ1MVs.mjs')
  },
  {
    name: "reset-password",
    path: "/reset-password",
    meta: __nuxt_page_meta$i || {},
    component: () => import('./index-CvK3iAor.mjs')
  },
  {
    name: "sign-in-sign-in-form",
    path: "/sign-in/sign-in-form",
    component: () => import('./sign-in-form-aqHXmSWh.mjs')
  },
  {
    name: "sign-up-sign-up-form",
    path: "/sign-up/sign-up-form",
    component: () => import('./sign-up-form-Bz748xXA.mjs')
  },
  {
...
const ipxRuntime$g6DZfLk_45DTmpp7jmvMkL7A379wsIWfU84c_45qrhTXC7U = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  getImage,
  operationsGenerator,
  supportsAlias,
...
const imageOptions = {
  ...
  providers: {
    ["ipx"]: { provider: ipxRuntime$g6DZfLk_45DTmpp7jmvMkL7A379wsIWfU84c_45qrhTXC7U, defaults: {} }
  }
};
...
const layouts = {
  auth: defineAsyncComponent(() => import('./auth-D9Qt_XGr.mjs').then((m) => m.default || m)),
  main: defineAsyncComponent(() => import('./main-DfpbIbh0.mjs').then((m) => m.default || m)),
  user: defineAsyncComponent(() => import('./user-Dny2zi9i.mjs').then((m) => m.default || m))
};
...
export { get as A, _sfc_main$e as B, getDisplayValue as C, useState as D, formBusInjectionKey as E, formStateInjectionKey as F, formErrorsInjectionKey as G, formInputsInjectionKey as H, formLoadingInjectionKey as I, formOptionsInjectionKey as J, inputIdInjectionKey as K, formFieldInjectionKey as L, omit as M, _sfc_main$b as N, pickLinkProps as O, _sfc_main$c as P, compare as Q, avatarGroupInjectionKey as R, useRoute as S, createError as T, useRouter as U, useNuxtApp as V, __nuxt_component_1$1 as W, __nuxt_component_0 as _, __nuxt_component_4 as a, useRuntimeConfig as b, _sfc_main$a as c, __nuxt_component_0$1 as d, entry$1 as default, _sfc_main$g as e, useLocale as f, useAppConfig as g, useToast as h, _sfc_main$4 as i, authClient as j, useConfirm as k, _sfc_main$d as l, useFormField as m, __nuxt_component_12 as n, navigateTo as o, useFieldGroup as p, useComponentIcons as q, fetchDefaults as r, useAsyncData as s, tv as t, useHead as u, useRequestFetch as v, fieldGroupInjectionKey as w, looseToNumber as x, usePortal as y, isArrayOfArray as z };
