...
const accountId$1 = ref("0021351082");
const accountName$1 = ref("Eli and Lulu");
const __nuxt_page_meta$u = {
  layout: "user",
  breadcrumb: [
    {
    ...
    {
      label: accountName$1,
      to: `/user/accounts/${accountId$1.value}`
    },
    {
      label: "Transfer"
    }
...
async function createClientPage(loader) {
  _createClientPage ||= await import('./client-component-DUHRDRCt.mjs').then((r) => r.createClientPage);
...
const _routes = [
  {
    ...
    component: () => import('./index-CIj-vWnR.mjs')
  },
  {
    name: "user",
    path: "/user",
    meta: __nuxt_page_meta$10 || {},
    component: () => import('./index-BxuKUzko.mjs')
  },
  {
    name: "admin",
    path: "/admin",
    meta: __nuxt_page_meta$$ || {},
    component: () => import('./index-D4WiCIz-.mjs')
  },
  {
    name: "admin-users",
    path: "/admin/users",
    meta: __nuxt_page_meta$_ || {},
    component: () => import('./users-CW7Zb1hb.mjs')
  },
  {
    name: "contact",
    path: "/contact",
    meta: { ...__nuxt_page_meta$Z || {}, ...{ "groups": ["main"] } },
    component: () => import('./contact-DbRALtC8.mjs')
  },
  {
    name: "admin-kyc-data",
    path: "/admin/kyc-data",
    meta: __nuxt_page_meta$Y || {},
    component: () => import('./kyc-data-dPYhf3DL.mjs')
  },
  {
    name: "admin-settings",
    path: "/admin/settings",
    meta: __nuxt_page_meta$X || {},
    component: () => import('./settings-DQqeqxZZ.mjs')
  },
  {
    name: "admin-banned-ips",
    path: "/admin/banned-ips",
    meta: __nuxt_page_meta$W || {},
    component: () => import('./banned-ips-DAxuANW2.mjs')
  },
  {
    name: "admin-currencies",
    path: "/admin/currencies",
    meta: __nuxt_page_meta$V || {},
    component: () => import('./currencies-C_hCL2on.mjs')
  },
  {
    name: "about-story",
    path: "/about/story",
    meta: { ...__nuxt_page_meta$U || {}, ...{ "groups": ["main"] } },
    component: () => import('./story-CPokM0zj.mjs')
  },
  {
    name: "admin-transactions",
    path: "/admin/transactions",
    meta: __nuxt_page_meta$T || {},
    component: () => import('./transactions-DuYrYo1m.mjs')
  },
  {
    name: "user-contact",
    path: "/user/contact",
  ...
  },
  {
    ...
    path: "/user/profile",
    component: () => import('./index-cKaHucHe.mjs'),
    children: [
      {
        name: "user-profile-index-kyc",
        path: "kyc",
        meta: __nuxt_page_meta$R || {},
        component: () => import('./kyc-9xHhBVso.mjs')
      },
      {
        name: "",
        path: "",
        meta: __nuxt_page_meta$Q || {},
        component: () => import('./index-ExFp0pJI.mjs')
      }
    ]
  },
  {
    ...
    component: () => import('./index-DYxWFbPy.mjs'),
    children: [
      {
        name: "user-accounts-index",
        path: "",
        component: () => import('./index-CYjnqmlB.mjs')
      },
      {
        name: "user-accounts-index-join-requests",
        path: "join-requests",
        component: () => import('./join-requests-91VFSHv0.mjs')
      }
    ]
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        path: "withdraw",
        meta: __nuxt_page_meta$t || {},
        component: () => import('./withdraw-CMFVNI1W.mjs')
      },
      {
        name: "user-accounts-accountId-documents",
        path: "documents",
        meta: __nuxt_page_meta$s || {},
        component: () => import('./documents-FtGX2NdM.mjs')
      },
      {
        name: "user-accounts-accountId-account-users",
        path: "account-users",
        meta: __nuxt_page_meta$r || {},
        component: () => import('./account-users-CBaRWEOl.mjs')
      },
      {
        name: "user-accounts-accountId-notifications",
        path: "notifications",
        meta: __nuxt_page_meta$q || {},
        component: () => import('./notifications-Dcv816Ey.mjs')
      },
      {
        name: "user-accounts-accountId-business-profile",
        path: "business-profile",
        component: () => import('./business-profile-BsBcOCh6.mjs')
      },
      {
        name: "user-accounts-accountId-investments",
        path: "investments",
        meta: __nuxt_page_meta$p || {},
        component: () => import('./index-DyFXzZlw.mjs')
      },
      {
        name: "user-accounts-accountId-transactions",
        path: "transactions",
        meta: __nuxt_page_meta$o || {},
        component: () => import('./index-B6AehGaY.mjs')
      },
      {
        name: "user-accounts-accountId-investments-investmentId",
        path: "investments/:investmentId()",
        meta: __nuxt_page_meta$n || {},
        component: () => import('./_investmentId_-CURw7GOC.mjs')
      },
      {
        name: "user-accounts-accountId-transactions-transactionId",
        path: "transactions/:transactionId()",
        component: () => createClientPage(() => import('./_transactionId_.client-CcF6XO9l.mjs'))
      }
    ]
  },
  {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(ToastRoot), mergeProps({
        ...
        default: withCtx(({ remaining, duration, open: open2 }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ssrRenderSlot(_ctx.$slots, "leading", {}, () => {
              if (__props.avatar) {
            ...
            if (__props.progress && open2 && remaining > 0 && duration) {
            ...
            return [
              ...
              __props.progress && open2 && remaining > 0 && duration ? (openBlock(), createBlock(_sfc_main$9, mergeProps({
                key: 1,
                "model-value": remaining / duration * 100,
                color: __props.color
              }, typeof __props.progress === "object" ? __props.progress : {}, {
...
const UToaster = Object.assign(_sfc_main$7, { __name: "NuxtToaster" });
function _useOverlay() {
  ...
  const create = (component, _options) => {
    ...
    return {
      ...options,
      open: (props2) => open2(options.id, props2),
      close: (value) => close(options.id, value),
      patch: (props2) => patch(options.id, props2)
    };
  };
  const open2 = (id, props) => {
...
const __nuxt_component_1 = Object.assign(_sfc_main$5, { __name: "NuxtApp" });
const theme = {
  "slots": {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(DialogRoot), mergeProps(unref(rootProps), _attrs), {
        default: withCtx(({ open: open2, close }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (!!slots.default) {
              _push2(ssrRenderComponent(unref(DialogTrigger), {
                ...
                default: withCtx((_, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ssrRenderSlot(_ctx.$slots, "default", { open: open2 }, null, _push3, _parent3, _scopeId2);
                  } else {
                    return [
                      renderSlot(_ctx.$slots, "default", { open: open2 })
                    ];
                  }
                }),
                _: 2
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const { open: open2, config: config2, close } = useConfirm();
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtModal, mergeProps({
        ...
        title: unref(config2)?.title,
        description: unref(config2)?.description,
        icon: unref(config2)?.icon,
        dismissible: false,
        close: unref(config2)?.showCloseIcon
      }, _attrs), {
        footer: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="w-full flex items-center justify-end gap-2"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_NuxtButton, mergeProps(unref(config2)?.rejectProps, {
              onClick: async () => {
                await unref(config2)?.reject?.();
                unref(close)();
              }
            }), {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(config2)?.rejectProps?.label)}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(unref(config2)?.rejectProps?.label), 1)
                  ];
                }
              }),
              _: 1
            }, _parent2, _scopeId));
            _push2(ssrRenderComponent(_component_NuxtButton, mergeProps(unref(config2)?.acceptProps, {
              onClick: async () => {
                await unref(config2)?.accept?.();
                unref(close)();
              }
            }), {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(config2)?.acceptProps?.label)}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(unref(config2)?.acceptProps?.label), 1)
                  ];
                }
              }),
              _: 1
            ...
            return [
              createVNode("div", { class: "w-full flex items-center justify-end gap-2" }, [
                createVNode(_component_NuxtButton, mergeProps(unref(config2)?.rejectProps, {
                  onClick: async () => {
                    await unref(config2)?.reject?.();
                    unref(close)();
                  }
                ...
                createVNode(_component_NuxtButton, mergeProps(unref(config2)?.acceptProps, {
                  onClick: async () => {
                    await unref(config2)?.accept?.();
                    unref(close)();
                  }
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/nuxt/confirm-dialog.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const __nuxt_component_2 = Object.assign(_sfc_main$3, { __name: "NuxtConfirmDialog" });
const layouts = {
  auth: defineAsyncComponent(() => import('./auth-DBxvF_Ns.mjs').then((m) => m.default || m)),
  main: defineAsyncComponent(() => import('./main-BB4Jh1PF.mjs').then((m) => m.default || m)),
  user: defineAsyncComponent(() => import('./user-CTg2AuWA.mjs').then((m) => m.default || m))
};
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtApp, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_NuxtConfirmDialog, null, null, _parent2, _scopeId));
            ...
            return [
              createVNode(_component_NuxtConfirmDialog),
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const message = computed(
      () => __props.error.statusMessage || __props.error.message || "An unexpected error occurred"
    );
    const handleClearError = () => clearError({ redirect: "/" });
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtButton = _sfc_main$a;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-full min-h-screen flex-center bg-default" }, _attrs))}><div class="max-w-[28rem] w-full px-6 text-center space-y-4"><p class="text-6xl font-bold text-muted">${ssrInterpolate(__props.error.statusCode)}</p><p class="text-lg">${ssrInterpolate(unref(message))}</p>`);
...
export { formFieldInjectionKey as A, usePortal as B, isArrayOfArray as C, get as D, _sfc_main$e as E, getDisplayValue as F, formBusInjectionKey as G, formStateInjectionKey as H, formLoadingInjectionKey as I, formOptionsInjectionKey as J, _sfc_main$b as K, pickLinkProps as L, _sfc_main$c as M, omit as N, compare as O, avatarGroupInjectionKey as P, useRoute as Q, createError as R, useRouter as S, __nuxt_component_1$1 as T, useHead as U, __nuxt_component_5 as _, _sfc_main$a as a, _sfc_main$f as b, useLocale as c, useAppConfig as d, entry_default as default, useToast as e, _sfc_main$4 as f, authClient as g, useConfirm as h, _sfc_main$d as i, useFormField as j, __nuxt_component_12 as k, __nuxt_component_2$1 as l, useFieldGroup as m, navigateTo as n, useComponentIcons as o, useState as p, fetchDefaults as q, useAsyncData as r, useNuxtApp as s, tv as t, useRuntimeConfig as u, fieldGroupInjectionKey as v, looseToNumber as w, formErrorsInjectionKey as x, formInputsInjectionKey as y, inputIdInjectionKey as z };
