    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<button class="${ssrRenderClass([unref(classes).button, "cursor-pointer pointer-events-none rounded-full font-medium px-6 py-3 flex items-center gap-2 transition-colors"])}"${_scopeId}><p${_scopeId}>${ssrInterpolate(!unref(authStore).user.value ? __props.buttonLabel || "Create Account" : "Log in to your AssetFusionX account")}</p>`);
            ...
            return [
              createVNode("button", {
                ...
                createVNode("p", null, toDisplayString(!unref(authStore).user.value ? __props.buttonLabel || "Create Account" : "Log in to your AssetFusionX account"), 1),
...
//# sourceMappingURL=cta-banner-BWzTdaJm.mjs.map
