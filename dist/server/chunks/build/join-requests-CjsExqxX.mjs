...
import { g as useToast, h as _sfc_main$4, b as _sfc_main$a, k as _sfc_main$d } from './server.mjs';
...
import { defineComponent, withAsyncContext, computed, ref, mergeProps, unref, withCtx, createVNode, toDisplayString, createTextVNode, openBlock, createBlock, createCommentVNode, Fragment, renderList, useSSRContext } from 'vue';
          ...
          if (_push2) {
            if (unref(data)) {
              ...
              if (unref(joinRequests).length > 0) {
                _push2(`<div class="grid gap-4 md:grid-cols-[repeat(auto-fill,minmax(28rem,1fr))]"${_scopeId}><!--[-->`);
...
//# sourceMappingURL=join-requests-CjsExqxX.mjs.map
