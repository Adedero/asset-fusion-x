import { useSlots, computed, provide, unref, mergeProps, withCtx, createVNode, resolveDynamicComponent, openBlock, createBlock, createCommentVNode, Fragment, renderList, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrRenderList, ssrRenderVNode } from 'vue/server-renderer';
import { Primitive } from 'reka-ui';
import { d as useAppConfig, t as tv, P as avatarGroupInjectionKey, i as _sfc_main$d } from './server.mjs';
      ...
      _push(ssrRenderComponent(unref(Primitive), mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              hiddenCount.value > 0 ? (openBlock(), createBlock(_sfc_main$d, {
                key: 0,
                text: `+${hiddenCount.value}`,
                class: ui.value.base({ class: props.ui?.base })
...
//# sourceMappingURL=AvatarGroup-Y0AGil1R.mjs.map
