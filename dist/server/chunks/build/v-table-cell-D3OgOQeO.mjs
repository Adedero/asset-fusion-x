import { b as _sfc_main$f } from './server.mjs';
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[-->`);
      if (unref(props)?.loading && unref(props)?.loaderType === "carousel") {
        _push(`<div class="absolute top-0 left-0 w-full h-full z-10" data-v-f640a5ef><div class="w-full mt-[3.25rem] h-[2.5px] bg-primary-100 overflow-hidden" data-v-f640a5ef><div class="h-full bg-primary-500 animate-carousel" data-v-f640a5ef></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(props)?.loading && unref(props)?.loaderType === "spinner") {
        _push(`<div class="absolute top-0 left-0 w-full h-full z-10 bg-muted/10 backdrop-blur-xs flex-center" data-v-f640a5ef>`);
...
_sfc_main$6.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/v-table/v-table-loader.vue");
  return _sfc_setup$6 ? _sfc_setup$6(props, ctx) : void 0;
};
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$6, [["__scopeId", "data-v-f640a5ef"]]), { __name: "VTableLoader" });
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_VTableLoader = __nuxt_component_0;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "relative" }, _attrs))}>`);
      _push(ssrRenderComponent(_component_VTableLoader, null, null, _parent));
      _push(`<div class="overflow-auto"><table${ssrRenderAttrs(mergeProps({
        border: "collapse",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (unref(props)) {
        _push(`<thead${ssrRenderAttrs(mergeProps({
          class: ["relative border-b-2 border-b-default [&_th]:py-4 [&_th]:px-4", unref(props).stickyHeader ? "sticky top-0" : ""]
        }, _attrs))}>`);
        ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
        _push(`</thead>`);
      } else {
...
const __nuxt_component_1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]), { __name: "VTableCell" });

export { __nuxt_component_5 as _, __nuxt_component_6 as a, __nuxt_component_7 as b, __nuxt_component_8 as c, __nuxt_component_9 as d, __nuxt_component_1 as e };
//# sourceMappingURL=v-table-cell-D3OgOQeO.mjs.map
