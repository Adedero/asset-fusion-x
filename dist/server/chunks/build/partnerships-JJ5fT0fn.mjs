import { _ as __nuxt_component_0 } from './partner-list-BqQRVKRv.mjs';
import { _ as _sfc_main$1 } from './Separator-DwcB_Qjm.mjs';
...
const _imports_0 = publicAssetsURL("/img/pages/about/partnerships.jpg");
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "partnerships",
  __ssrInlineRender: true,
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_MainPartnerList = __nuxt_component_0;
...
//# sourceMappingURL=partnerships-JJ5fT0fn.mjs.map
