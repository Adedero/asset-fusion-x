import { _ as __nuxt_component_1 } from './currency-select-CoNrA_j5.mjs';
import { d as _sfc_main$f, c as useRuntimeConfig, b as _sfc_main$a, h as _sfc_main$4$1, g as useToast } from './server.mjs';
import { _ as _sfc_main$4 } from './Card-B81ZNWgd.mjs';
import { _ as _sfc_main$5 } from './Form-BhNutJZb.mjs';
import { _ as __nuxt_component_14 } from './fetch-error-alert-Cos-JGNP.mjs';
import { _ as _sfc_main$6 } from './FormField-DYdB-maE.mjs';
import { _ as _sfc_main$7 } from './InputNumber-B8pnVdzm.mjs';
import { _ as _sfc_main$8 } from './Badge-4IrPO892.mjs';
import { _ as _sfc_main$9 } from './Alert-9mK7K0n2.mjs';
import { defineComponent, ref, mergeProps, isRef, unref, withCtx, createVNode, toDisplayString, reactive, createTextVNode, openBlock, createBlock, createCommentVNode, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderSlot } from 'vue/server-renderer';
import { a8 as normalizeException } from '../_/nitro.mjs';
import { _ as _sfc_main$b } from './Input-CFyDl-v5.mjs';
import { _ as _sfc_main$c } from './FieldGroup-CbIMy4e7.mjs';
import { t as toDollar } from './to-dollar-DdS_9tlH.mjs';
import z from 'zod';
import { u as useRouteData } from './use-route-data-zpNPSzN0.mjs';
import 'reka-ui';
import '@vueuse/core';
import './fetch-CMVOWH-m.mjs';
import '@vue/shared';
import 'vue-router';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_NuxtInputNumber = _sfc_main$7;
      const _component_NuxtButton = _sfc_main$a;
      ...
      const _component_NuxtFieldGroup = _sfc_main$c;
            ...
            if (unref(transaction)) {
              ...
              if (__props.currency.symbol === "WIRE") {
                ...
                _push2(ssrRenderComponent(_component_NuxtFormField, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(ssrRenderComponent(_component_NuxtFieldGroup, { class: "w-full" }, {
                      ...
                      return [
                        createVNode(_component_NuxtFieldGroup, { class: "w-full" }, {
                          default: withCtx(() => [
                            createVNode(_component_NuxtInput, {
                              value: unref(transaction).amount,
                              readonly: "",
                    ...
                    if (_push3) {
                      _push3(ssrRenderComponent(_component_NuxtFieldGroup, { class: "w-full" }, {
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(ssrRenderComponent(_component_NuxtInput, {
                              value: __props.currency.walletAddress,
                              size: "lg",
                              class: "w-full"
                            }, null, _parent4, _scopeId3));
                            _push4(ssrRenderComponent(_component_TextCopyButton, {
                              text: __props.currency.walletAddress,
                              variant: "outline"
                            }, null, _parent4, _scopeId3));
                          } else {
                            return [
                    ...
                    if (_push3) {
                      _push3(ssrRenderComponent(_component_NuxtFieldGroup, { class: "w-full" }, {
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(ssrRenderComponent(_component_NuxtInput, {
                              value: __props.currency.walletAddressNetwork,
                              size: "lg",
                              class: "w-full"
                            }, null, _parent4, _scopeId3));
                            _push4(ssrRenderComponent(_component_TextCopyButton, {
                              text: __props.currency.walletAddressNetwork,
                              variant: "outline"
                            }, null, _parent4, _scopeId3));
                          } else {
                            return [
...
//# sourceMappingURL=deposit-De9I-RCy.mjs.map
