...
const c$1 = class c {
  ...
  constructor(e = new i$1(), t = new l$1()) {
    (Object.assign(this, e),
      ...
      (this._destroy = m(e._destroy, t._destroy)));
  }
};
function _() {
  return (
...
const c = /*@__PURE__*/ (function () {
  class o {
      ...
      return e === "string" && n === "string"
        ...
        : e === "number" && n === "number"
          ...
          : String.prototype.localeCompare.call(
              this.serialize(t, true),
              this.serialize(r, true)
            );
    }
    serialize(t, r) {
    ...
    serializeObject(t) {
      ...
      if (n !== "" && globalThis[n] === e)
        return this.serializeBuiltInType(n, t);
    ...
    serializeBuiltInType(t, r) {
      ...
      if (typeof r?.entries == "function")
        return this.serializeObjectEntries(t, r.entries());
    ...
    serializeObjectEntries(t, r) {
      ...
      for (let i = 0; i < e.length; i++) {
        const [a, l] = e[i];
        ((n += `${this.serialize(a, true)}:${this.serialize(l)}`),
          i < e.length - 1 && (n += ","));
      }
      return n + "}";
    }
    $object(t) {
      ...
      return (
        r === void 0 &&
          (this.#t.set(t, `#${this.#t.size}`),
          (r = this.serializeObject(t)),
          this.#t.set(t, r)),
        r
      );
    }
...
const _inlineRuntimeConfig = {
  app: {
    baseURL: "/",
    buildId: "55f8d46e-8f4a-4be4-b37b-d01d13c102e5",
  ...
  public: {
    ...
    defaultErrorMsg:
      "Something happened and we are working on it. Please, try again alter",
...
const errorHandler$0 = async function errorhandler(
  ...
  errorObject.url =
    withoutBase(url.pathname, useRuntimeConfig(event).app.baseURL) +
    url.search +
    url.hash;
...
const config = {
  generator: {
    ...
    output: {
      value:
        "C:\\Users\\adedero\\Documents\\dev\\apps\\asset-fusion-x\\server\\generated\\prisma",
      fromEnvVar: null
    },
    config: {
      engineType: "library"
    ...
    previewFeatures: [],
    sourceFilePath:
      "C:\\Users\\adedero\\Documents\\dev\\apps\\asset-fusion-x\\prisma\\schema.prisma",
    isCustomOutput: true
  },
  relativePath: "../../../prisma",
  ...
  inlineSchemaHash:
    "239b196db38034a19769c803ed725201d31878fc2eac3c14bab286ceec8dda30",
  copyEngine: true,
  runtimeDataModel: {
    models: {},
    enums: {},
...
globalThis["__dirname"] = __filename ? path.dirname(__filename) : process.cwd();
...
path.join(
  process$1.cwd(),
  "server/generated/prisma/libquery_engine-debian-openssl-1.0.x.so.node"
);
...
const sendEmail = async (mailOptions) => {
  ...
  try {
    const info = await transporter.sendMail({
      from: {
        name: "AssetFusionX",
        address: (_a = process.env.EMAIL_USER) != null ? _a : ""
      },
      ...mailOptions
    });
...
function Button({ label, href, centered = true }) {
  return `
  ...
  try {
    ...
    for (const investment of eligibleInvestments) {
      try {
        ...
        const isLastCycle =
          ((_a = investmentUpdates.daysCompleted) != null ? _a : 0) + 1 >=
          investment.duration;
        if (isLastCycle) {
...
const assets = {
  ...
  "/_nuxt/20-joxqj.js": {
    ...
    mtime: "2026-02-26T13:38:18.246Z",
    size: 432083,
  ...
  "/_nuxt/-7KF7Ksm.js": {
    ...
    mtime: "2026-02-26T13:38:18.255Z",
    size: 547,
  ...
  "/_nuxt/8DtHchtE.js": {
    ...
    mtime: "2026-02-26T13:38:18.264Z",
    size: 17864,
  ...
  "/_nuxt/7bjDdDQv.js": {
    ...
    mtime: "2026-02-26T13:38:18.252Z",
    size: 3277,
  ...
  "/_nuxt/9ThFSRxC.js": {
    ...
    mtime: "2026-02-26T13:38:18.250Z",
    size: 522,
  ...
  "/_nuxt/9Sj_QenJ.js": {
    ...
    mtime: "2026-02-26T13:38:18.259Z",
    size: 30,
  ...
  "/_nuxt/B0Smg3zh.js": {
    ...
    mtime: "2026-02-26T13:38:18.257Z",
    size: 23972,
  ...
  "/_nuxt/ai-nQuqq.js": {
    ...
    mtime: "2026-02-26T13:38:18.251Z",
    size: 670,
  ...
  "/_nuxt/B2AoQlJr.js": {
    ...
    mtime: "2026-02-26T13:38:18.254Z",
    size: 1283,
  ...
  "/_nuxt/B4D6YOGr.js": {
    ...
    mtime: "2026-02-26T13:38:18.247Z",
    size: 9276,
  ...
  "/_nuxt/B67SjTdi.js": {
    ...
    mtime: "2026-02-26T13:38:18.258Z",
    size: 8686,
  ...
  "/_nuxt/BA8IAspe.js": {
    ...
    mtime: "2026-02-26T13:38:18.256Z",
    size: 8602,
  ...
  "/_nuxt/BaBkOfbl.js": {
    ...
    mtime: "2026-02-26T13:38:18.263Z",
    size: 42622,
  ...
  "/_nuxt/BEm_88W5.js": {
    ...
    mtime: "2026-02-26T13:38:18.248Z",
    size: 491,
  ...
  "/_nuxt/BGHEBHRw.js": {
    ...
    mtime: "2026-02-26T13:38:18.261Z",
    size: 12737,
  ...
  "/_nuxt/BoRocCL0.js": {
    ...
    mtime: "2026-02-26T13:38:18.262Z",
    size: 430,
  ...
  "/_nuxt/BIpI0Us3.js": {
    ...
    mtime: "2026-02-26T13:38:18.260Z",
    size: 227,
  ...
  "/_nuxt/Bzr520pe.js": {
    ...
    mtime: "2026-02-26T13:38:18.265Z",
    size: 22449,
  ...
  "/_nuxt/C-z8g5C1.js": {
    ...
    mtime: "2026-02-26T13:38:18.249Z",
    size: 3353,
  ...
  "/_nuxt/C1jteZ08.js": {
    ...
    mtime: "2026-02-26T13:38:18.277Z",
    size: 1540962,
  ...
  "/_nuxt/entry.CQs8IwrG.css": {
    ...
    mtime: "2026-02-26T13:38:18.245Z",
    size: 181007,
  ...
  "/_nuxt/GeistMono.BlNDD6KS.ttf": {
    ...
    mtime: "2026-02-26T13:38:18.244Z",
    size: 137804,
  ...
  "/_nuxt/Poppins.CTKNfV9P.ttf": {
    ...
    mtime: "2026-02-26T13:38:18.126Z",
    size: 158240,
  ...
  "/_nuxt/builds/latest.json": {
    ...
    etag: '"47-5iHxcKQ+ottgEOhnqK/zYAem2Lo"',
    mtime: "2026-02-26T13:39:00.423Z",
    size: 71,
  ...
  "/_nuxt/builds/meta/55f8d46e-8f4a-4be4-b37b-d01d13c102e5.json": {
    type: "application/json",
    etag: '"58-nh/jwF0q9HNJU8zYkR30uHavKI4"',
    mtime: "2026-02-26T13:39:00.424Z",
    size: 88,
    path: "../public/_nuxt/builds/meta/55f8d46e-8f4a-4be4-b37b-d01d13c102e5.json"
  },
...
function emailVerificationTemplate({ user, url, subject }) {
  const body = `
<section>
  <section>
    Hello, <b>${user.name}</b>
...
function resetPasswordTemplate({ user, url, subject }) {
  const body = `
<section>
  <section>
    Hello, <b>${user.name}</b>
...
function emailChangeTemplate({ user, url, subject }) {
  const body = `
<section>
  <section>
    Hello, <b>${user.name}</b>
...
async function saveUserImage(
  userId,
  base64Image,
  outputDir = resolve$2("public/uploads/img/users")
) {
...
const _ru5xrU = defineCachedEventHandler(
  async (event) => {
    const url = getRequestURL(event);
    if (!url)
    ...
    if (collection) {
      if (icons?.length) {
        ...
        consola.debug(
          `[Icon] serving ${(icons || []).map((i) => "`" + collectionName + ":" + i + "`").join(",")} from bundled collection`
        );
        return data;
      }
    }
    if (
      ...
      consola.debug(
        `[Icon] fetching ${(icons || []).map((i) => "`" + collectionName + ":" + i + "`").join(",")} from iconify api`
      );
...
const _lazy_90Wl3w = () =>
  import("../routes/api/admin/business-profiles/_profileId_.put.mjs");
const _lazy_plbmks = () => import("../routes/api/admin/index.get.mjs");
const _lazy_A7JMAV = () =>
  import("../routes/api/admin/currencies/_currencyId_.delete.mjs");
const _lazy_2XA6DL = () =>
  import("../routes/api/admin/currencies/_currencyId_.put.mjs");
const _lazy_nLGosX = () => import("../routes/api/admin/index.post.mjs");
const _lazy_x17vfB = () =>
  import("../routes/api/admin/financial-accounts/_accountId_.delete.mjs");
const _lazy_2qBK8h = () =>
  import("../routes/api/admin/financial-accounts/_accountId_.put.mjs");
const _lazy_MwJVQa = () => import("../routes/api/admin/index.get2.mjs");
const _lazy_ycYEEC = () =>
  import("../routes/api/admin/investment-plans/_investmentPlanId_.delete.mjs");
const _lazy_E2tnil = () =>
  import("../routes/api/admin/investment-plans/_investmentPlanId_.put.mjs");
const _lazy_PadsI2 = () => import("../routes/api/admin/index.post2.mjs");
const _lazy_5nU_sk = () =>
  import("../routes/api/admin/investments/index.delete.mjs");
const _lazy_7G4Fk2 = () =>
  import("../routes/api/admin/investments/index.get.mjs");
const _lazy_74Z2nL = () =>
  import("../routes/api/admin/investments/index.put.mjs");
const _lazy_WWsAsV = () => import("../routes/api/admin/index.get3.mjs");
const _lazy_35JkGx = () =>
  import("../routes/api/admin/kyc-data/_profileId_.put.mjs");
const _lazy_vG1U1Z = () => import("../routes/api/admin/index.get4.mjs");
const _lazy_MfLumC = () => import("../routes/api/admin/overview.mjs");
const _lazy_W4NE1Y = () =>
  import("../routes/api/admin/profits/_profitId_.put.mjs");
const _lazy_NOAhP4 = () => import("../routes/api/admin/index.put.mjs");
const _lazy_sflZCa = () =>
  import("../routes/api/admin/transactions/_transactionId_.put.mjs");
...
const _lazy_VhXLXN = () =>
  import("../routes/api/user/financial-accounts/_accountId/account-user/_accountUserId_.delete.mjs");
const _lazy_CXVR7K = () =>
  import("../routes/api/user/financial-accounts/_accountId/account-users.get.mjs");
const _lazy_BbOULU = () =>
  import("../routes/api/user/financial-accounts/_accountId/business-profile.get.mjs");
const _lazy_QmIaR2 = () =>
  import("../routes/api/user/financial-accounts/_accountId/business-profile.put.mjs");
const _lazy_gSv27V = () =>
  import("../routes/api/user/financial-accounts/index.get.mjs");
const _lazy_0CLtI3 = () =>
  import("../routes/api/user/financial-accounts/index.put.mjs");
const _lazy_rrEoM3 = () =>
  import("../routes/api/user/financial-accounts/_accountId/investments/index.get.mjs");
const _lazy_GOnV_W = () =>
  import("../routes/api/user/financial-accounts/_accountId/investments/_investmentId/profits.get.mjs");
const _lazy_IP_1QQ = () =>
  import("../routes/api/user/financial-accounts/_accountId/investments/_investmentId/terminate.put.mjs");
const _lazy_8dRetK = () =>
  import("../routes/api/user/financial-accounts/_accountId/index.get.mjs");
const _lazy_iq6YXy = () =>
  import("../routes/api/user/financial-accounts/_accountId/index.post.mjs");
const _lazy_DNArRC = () =>
  import("../routes/api/user/financial-accounts/_accountId/join-requests.get.mjs");
const _lazy_aJYvPz = () =>
  import("../routes/api/user/financial-accounts/_accountId/join-requests.post.mjs");
const _lazy_0FbMZ9 = () =>
  import("../routes/api/user/financial-accounts/_accountId/mod-requests/_modRequestId_.put.mjs");
const _lazy_JQapnh = () =>
  import("../routes/api/user/financial-accounts/_accountId/index.get2.mjs");
const _lazy_liVE7b = () =>
  import("../routes/api/user/financial-accounts/_accountId/notifications.get.mjs");
const _lazy_b4tqxA = () =>
  import("../routes/api/user/financial-accounts/_accountId/transactions/_transactionId_.get.mjs");
const _lazy_u1wQ61 = () =>
  import("../routes/api/user/financial-accounts/_accountId/index.get3.mjs");
...
const _lazy_RmoISO = () =>
  import("../routes/api/user/join-requests/_requestId/accept.post.mjs");
const _lazy_Qoe28u = () =>
  import("../routes/api/user/join-requests/index.delete.mjs");
const _lazy_oTv_fA = () =>
  import("../routes/api/user/join-requests/_requestId/send-reminder.post.mjs");
const _lazy_VNHFTQ = () => import("../routes/api/user/index.get2.mjs");
const _lazy_5wkYeH = () =>
  import("../routes/api/user/notifications/_notificationId_.delete.mjs");
...
const _lazy_tPECjx = () =>
  import("../routes/api/user/notifications/unread/check.get.mjs");
const _lazy_7bylS2 = () =>
  import("../routes/api/user/notifications/unread/count.get.mjs");
...
const _lazy_Se_ALn = () =>
  import("../routes/api/user/transactions/deposit.post.mjs");
const _lazy_zdG4cQ = () =>
  import("../routes/api/user/transactions/init-deposit.get.mjs");
const _lazy_rRgvZ6 = () =>
  import("../routes/api/user/transactions/init-withdrawal.get.mjs");
const _lazy_M7XOCF = () =>
  import("../routes/api/user/transactions/withdrawal.post.mjs");
const _lazy_67b7PT = () =>
...
const handlers = [
  ...
  {
    route: "/api/admin/business-profiles/:profileId",
    handler: _lazy_90Wl3w,
    lazy: true,
    middleware: false,
    method: "put"
  },
  {
    route: "/api/admin/business-profiles",
    handler: _lazy_plbmks,
    lazy: true,
    middleware: false,
    method: "get"
  },
  {
    route: "/api/admin/currencies/:currencyId",
    handler: _lazy_A7JMAV,
    lazy: true,
    middleware: false,
    method: "delete"
  },
  ...
  },
  {
    ...
    handler: _lazy_nLGosX,
    lazy: true,
    middleware: false,
    method: "post"
  },
  {
    route: "/api/admin/financial-accounts/:accountId",
    handler: _lazy_x17vfB,
    lazy: true,
    middleware: false,
    method: "delete"
  },
  {
    route: "/api/admin/financial-accounts/:accountId",
    handler: _lazy_2qBK8h,
    lazy: true,
    middleware: false,
    method: "put"
  },
  {
    route: "/api/admin/financial-accounts",
    handler: _lazy_MwJVQa,
    lazy: true,
    middleware: false,
    method: "get"
  },
  {
    route: "/api/admin/investment-plans/:investmentPlanId",
    handler: _lazy_ycYEEC,
    lazy: true,
    middleware: false,
    method: "delete"
  },
  ...
  },
  {
    ...
    handler: _lazy_PadsI2,
    lazy: true,
    middleware: false,
    method: "post"
  },
  {
    route: "/api/admin/investments/:investmentId",
    handler: _lazy_5nU_sk,
    lazy: true,
    middleware: false,
    method: "delete"
  },
  ...
  },
  {
    ...
    handler: _lazy_WWsAsV,
    lazy: true,
    middleware: false,
    method: "get"
  },
  {
    route: "/api/admin/kyc-data/:profileId",
    handler: _lazy_35JkGx,
    lazy: true,
    middleware: false,
    method: "put"
  },
  {
    route: "/api/admin/kyc-data",
    handler: _lazy_vG1U1Z,
    lazy: true,
    middleware: false,
    method: "get"
  },
  {
    ...
    handler: _lazy_MfLumC,
    lazy: true,
    middleware: false,
    method: undefined
  },
  {
    route: "/api/admin/profits/:profitId",
    handler: _lazy_W4NE1Y,
    lazy: true,
    middleware: false,
    method: "put"
  },
  {
    ...
    handler: _lazy_NOAhP4,
    lazy: true,
    middleware: false,
    method: "put"
  },
  {
    route: "/api/admin/transactions/:transactionId",
    handler: _lazy_sflZCa,
    lazy: true,
    middleware: false,
    method: "put"
  },
  ...
  },
  {
    ...
    handler: _lazy_VhXLXN,
    lazy: true,
    middleware: false,
    method: "delete"
  },
  {
    route: "/api/user/financial-accounts/:accountId/account-users",
    handler: _lazy_CXVR7K,
    lazy: true,
    middleware: false,
    method: "get"
  },
  {
    route: "/api/user/financial-accounts/:accountId/business-profile",
    handler: _lazy_BbOULU,
    lazy: true,
    middleware: false,
    method: "get"
  },
  {
    route: "/api/user/financial-accounts/:accountId/business-profile",
    handler: _lazy_QmIaR2,
    lazy: true,
    middleware: false,
    method: "put"
  },
  {
    route: "/api/user/financial-accounts/:accountId",
    handler: _lazy_gSv27V,
    lazy: true,
    middleware: false,
    method: "get"
  },
  {
    route: "/api/user/financial-accounts/:accountId",
    handler: _lazy_0CLtI3,
    lazy: true,
    middleware: false,
    method: "put"
  },
  {
    route: "/api/user/financial-accounts/:accountId/investments/:investmentId",
    handler: _lazy_rrEoM3,
    lazy: true,
    middleware: false,
    method: "get"
  },
  ...
  },
  {
    ...
    handler: _lazy_IP_1QQ,
    lazy: true,
    middleware: false,
    method: "put"
  },
  {
    route: "/api/user/financial-accounts/:accountId/investments",
    handler: _lazy_8dRetK,
    lazy: true,
    middleware: false,
    method: "get"
  },
  {
    route: "/api/user/financial-accounts/:accountId/investments",
    handler: _lazy_iq6YXy,
    lazy: true,
    middleware: false,
    method: "post"
  },
  {
    route: "/api/user/financial-accounts/:accountId/join-requests",
    handler: _lazy_DNArRC,
    lazy: true,
    middleware: false,
    method: "get"
  },
  {
    route: "/api/user/financial-accounts/:accountId/join-requests",
    handler: _lazy_aJYvPz,
    lazy: true,
    middleware: false,
    method: "post"
  },
  {
    route: "/api/user/financial-accounts/:accountId/mod-requests/:modRequestId",
    handler: _lazy_0FbMZ9,
    lazy: true,
    middleware: false,
    method: "put"
  },
  {
    route: "/api/user/financial-accounts/:accountId/mod-requests",
    handler: _lazy_JQapnh,
    lazy: true,
    middleware: false,
    method: "get"
  },
  {
    route: "/api/user/financial-accounts/:accountId/notifications",
    handler: _lazy_liVE7b,
    lazy: true,
    middleware: false,
    method: "get"
  },
  {
    ...
    handler: _lazy_b4tqxA,
    lazy: true,
    middleware: false,
    method: "get"
  },
  {
    route: "/api/user/financial-accounts/:accountId/transactions",
    handler: _lazy_u1wQ61,
    lazy: true,
    middleware: false,
    method: "get"
  },
  {
    route: "/api/user/financial-accounts",
    handler: _lazy_mhruhV,
    lazy: true,
    middleware: false,
    method: "get"
  },
  ...
  {
    route: "/api/user",
    handler: _lazy_irkD8G,
    lazy: true,
    middleware: false,
    method: "put"
  },
  {
    route: "/api/user/join-requests/:requestId/accept",
    handler: _lazy_RmoISO,
    lazy: true,
    middleware: false,
    method: "post"
  },
  {
    route: "/api/user/join-requests/:requestId",
    handler: _lazy_Qoe28u,
    lazy: true,
    middleware: false,
    method: "delete"
  },
  {
    route: "/api/user/join-requests/:requestId/send-reminder",
    handler: _lazy_oTv_fA,
    lazy: true,
    middleware: false,
    method: "post"
  },
  {
    route: "/api/user/join-requests",
    handler: _lazy_VNHFTQ,
    lazy: true,
    middleware: false,
    method: "get"
  },
  ...
  {
    route: "/api/user/notifications",
    handler: _lazy_3QBAgg,
    lazy: true,
    middleware: false,
    method: "put"
  },
  {
    route: "/api/user/notifications/unread/check",
    handler: _lazy_tPECjx,
    lazy: true,
    middleware: false,
    method: "get"
  },
  {
    route: "/api/user/notifications/unread/count",
    handler: _lazy_7bylS2,
    lazy: true,
    middleware: false,
    method: "get"
  },
  {
    route: "/api/user/pages/dashboard",
    handler: _lazy_979NZp,
    lazy: true,
    middleware: false,
    method: "get"
  },
  ...
  {
    route: "/api/user/profile",
    handler: _lazy_gNWUrT,
    lazy: true,
    middleware: false,
    method: "put"
  },
  {
    route: "/api/user/profile/kyc",
    handler: _lazy_T5bCXr,
    lazy: true,
    middleware: false,
    method: "put"
  },
  {
    route: "/api/user/transactions/deposit",
    handler: _lazy_Se_ALn,
    lazy: true,
    middleware: false,
    method: "post"
  },
  {
    route: "/api/user/transactions/init-deposit",
    handler: _lazy_zdG4cQ,
    lazy: true,
    middleware: false,
    method: "get"
  },
  {
    route: "/api/user/transactions/init-withdrawal",
    handler: _lazy_rRgvZ6,
    lazy: true,
    middleware: false,
    method: "get"
  },
  {
    route: "/api/user/transactions/withdrawal",
    handler: _lazy_M7XOCF,
    lazy: true,
    middleware: false,
    method: "post"
  },
...
function createNitroApp() {
  ...
  const localFetch = (input, init) => {
    ...
    return C(nodeHandler, input, init).then((response) =>
...
export {
  ...
  getUpdatedCurrencyData as E,
  checkBusinessProfileApproval as F,
  getJointAccountModApprovals as G,
  buildAssetsURL as H,
  getResponseStatusText as I,
  getResponseStatus as J,
  ...
  defuFn as X,
  withQuery as Y,
  sanitizeStatusCode as Z,
  parseURL as _,
  trapUnhandledNodeErrors as a,
  decodePath as a0,
  getContext as a1,
  withTrailingSlash as a2,
  withoutTrailingSlash as a3,
  $fetch$1 as a4,
  baseURL as a5,
  createHooks as a6,
  executeAsync as a7,
  normalizeException as a8,
  upperFirst as a9,
  hash$1 as aa,
  getPercentagePeriodicReturn as ab,
  useNitroApp as b,
  defineEventHandler as c,
  destr as d,
  createError$1 as e,
  getValidatedQuery as f,
  getRouterParams as g,
  terminateInvestment as h,
  auth as i,
  toWebRequest as j,
  sendEmail as k,
  getRequestParam as l,
  getRouterParam as m,
  notificationEmitter as n,
  removeFileByUrl as o,
  prisma as p,
  saveFile as q,
  readValidatedBody as r,
  setupGracefulShutdown as s,
  toNodeListener as t,
  useRuntimeConfig as u,
  checkUserKycApproval as v,
  round as w,
  reverseTransaction as x,
  generateAccountNumber as y,
  removeUserImage as z
};
