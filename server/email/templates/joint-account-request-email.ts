...
export default function jointAccountRequestEmail(
  ...
  <section>
    <section>
      ...
      <p>
        You have been invited to join a financial account on ${
          process.env.APP_NAME
        }. The details of the account are given below:
      </p>
    </section>
    ...
    <section>
      <p>To accept or reject this invitation, please sign in to ${
        process.env.APP_NAME
      }.</p>
