...
<template>
  <main>
    <div class="grid *:[grid-column:1/2] *:[grid-row:1/2]">
      <div class="flex flex-col items-center justify-center z-10">
        ...
        >
          ...
          <div class="mt-5">
            <p>
              Discover the world of publicly traded companies—from innovative
              startups to global giants. {{ appName }} connects you to the stock
              market with intelligence, clarity, and performance-focused
              strategies.
            </p>
          </div>
        </div>
      ...
      <div class="h-96">
        <img
          src="/img/pages/investments/stocks.jpg"
    ...
    <section class="py-24 px-16 grid grid-cols-2 gap-16 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-tertiary-500 mb-6">
          What Are Stocks?
        </h2>
        <p class="text-slate-300 mb-4">
          Stocks, also known as shares or equities, represent ownership in a
          company. When you own a stock, you own a fraction of that company and
          share in its profits and losses. Stocks are traded on exchanges like
          the NYSE and NASDAQ, enabling individuals and institutions to invest
          in the future of companies across industries.
        </p>
        <p class="text-slate-400">
          Over time, investing in stocks has proven to be one of the most
          effective ways to build wealth. The key lies in selecting the right
          companies, understanding market cycles, and staying informed.
        </p>
      </div>

      <div class="bg-white rounded-lg px-10 py-20">
        <img
          src="/img/pages/investments/what-are-stocks.svg"
          alt="Understanding stocks"
        />
      </div>
    </section>
    ...
    <section class="py-24 px-16">
      <h2 class="text-3xl font-semibold text-primary-500 text-center mb-14">
        Why Invest in Stocks?
      </h2>
      <div class="grid grid-cols-3 gap-10">
        ...
        <div class="bg-slate-800 p-8 rounded-2xl shadow-md">
          ...
          <p class="text-slate-400">
            Many established companies pay regular dividends to shareholders,
            offering a steady income stream on top of potential gains.
          </p>
        </div>
        <div class="bg-slate-800 p-8 rounded-2xl shadow-md">
          <div class="bg-white rounded-lg p-2 w-20 h-20">
          ...
          <p class="text-slate-400">
            Stocks are easy to buy and sell during market hours, giving you the
            flexibility to enter and exit positions quickly and efficiently.
          </p>
        </div>
      </div>
    </section>
    ...
    <section class="py-24 px-16 grid grid-cols-2 gap-16 items-center">
      <div class="rounded-xl bg-white shadow-lg px-2 py-6">
        <img
          src="/img/pages/investments/types-of-stocks.png"
          class="w-full h-full"
          alt="Types of stocks"
        />
      </div>
      <div>
        ...
        <p class="text-slate-300 mb-4">
          Not all stocks are created equal. Investors can choose from:
        </p>
        <ul class="text-slate-400 space-y-3 list-disc list-inside">
          <li>
            <span class="text-slate-100">Blue-chip stocks</span> - shares in
            large, stable companies with a history of solid performance.
          </li>
          <li>
            <span class="text-slate-100">Growth stocks</span> - companies
            expected to grow faster than the market average, often reinvesting
            profits.
          </li>
          <li>
            <span class="text-slate-100">Dividend stocks</span> - stocks that
            provide regular income through shareholder payouts.
          </li>
          <li>
            <span class="text-slate-100">Penny stocks</span> - low-priced stocks
            with high volatility and higher risk/reward potential.
          </li>
        </ul>
      </div>
    </section>
    ...
    <section class="py-24 px-16">
      <div class="text-center max-w-4xl mx-auto mb-16">
        <h2 class="text-3xl font-semibold text-primary-500 mb-4">
          How {{ appName }} Simplifies Stock Investing
        </h2>
        <p class="text-slate-400 text-lg">
          With {{ appName }}, you don't need to worry about brokerage platforms,
          technical analysis, or reading 50-page financial reports. We make
          investing in stocks smart, effortless, and accessible.
        </p>
      </div>
      <div class="grid grid-cols-3 gap-10">
        <div class="bg-slate-800 p-6 rounded-xl shadow-md">
          ...
          <p class="text-slate-400">
            Choose from themed baskets like “AI Innovators,” “Sustainable
            Energy,” or “Dividend Aristocrats”—professionally selected for
        ...
        <div class="bg-slate-800 p-6 rounded-xl shadow-md">
          ...
          <p class="text-slate-400">
            We do the market watching and decision-making. You simply pick a
            strategy, and we take care of the rest—seamlessly and securely.
          </p>
        </div>
        <div class="bg-slate-800 p-6 rounded-xl shadow-md">
          <h3 class="text-lg font-medium text-slate-100 mb-2">
          ...
          <p class="text-slate-400">
            Your dashboard provides real-time updates on your investments with
            clear visuals, earnings reports, and reallocation history.
          </p>
        </div>
      </div>
    </section>
    ...
    <section class="py-24 px-16 grid grid-cols-2 gap-16 items-center">
      <div>
        ...
        <p class="text-slate-300 mb-4">
          With {{ appName }}, you gain access to top stock markets around the
          world—including the U.S., Europe, and Asia. We break down barriers and
          enable participation in the global economy with a few clicks.
        </p>
        <p class="text-slate-400">
          Our platform handles currency conversions, trading regulations, and
          security compliance so that you can focus solely on your growth.
        </p>
      </div>
      <div>
        <img
          src="/img/pages/investments/global-stock-market.webp"
          alt="World market access"
    ...
    <!-- Real-World Examples -->
    <section class="py-24 px-16">
      <h2 class="text-3xl font-semibold text-primary-500 text-center mb-16">
        Real-World Stocks, Real Impact
      </h2>
      <div class="grid grid-cols-3 gap-10">
        <div class="bg-slate-800 p-6 rounded-xl shadow-md">
          ...
          <p class="text-slate-400">
            Pioneer in electric vehicles, energy storage, and autonomous driving
            technology.
          </p>
        </div>
        <div class="bg-slate-800 p-6 rounded-xl shadow-md">
          ...
          <p class="text-slate-400">
            Iconic consumer electronics brand with powerful global distribution
            and brand loyalty.
          </p>
        </div>
        <div class="bg-slate-800 p-6 rounded-xl shadow-md">
          ...
          <p class="text-slate-400">
            A key player in AI, gaming, and data center infrastructure with
            market-defining chips.
          </p>
        </div>
      </div>
    </section>
    ...
    <section class="py-24 px-16 max-w-5xl mx-auto">
      <h2 class="text-3xl font-semibold text-tertiary-500 text-center mb-12">
        FAQs About Stock Investing with {{ appName }}
      </h2>
      <div class="space-y-6">
        <details class="bg-slate-800 p-6 rounded-xl">
          <summary class="cursor-pointer text-tertiary-500 font-medium">
            Do I need a broker to use {{ appName }}?
          </summary>
          <p class="text-slate-400 mt-2">
            No. {{ appName }} acts as your intelligent investment engine. You
            don't need a broker or trading platform—we manage everything on your
            behalf.
          </p>
        </details>
        <details class="bg-slate-800 p-6 rounded-xl">
          <summary class="cursor-pointer text-tertiary-500 font-medium">
            Can I customize my stock portfolio?
          </summary>
          <p class="text-slate-400 mt-2">
            Yes. While we offer curated baskets, you can fine-tune exposure to
            industries, markets, or ESG principles based on your preferences.
          </p>
        </details>
        <details class="bg-slate-800 p-6 rounded-xl">
          <summary class="cursor-pointer text-tertiary-500 font-medium">
          ...
          <p class="text-slate-400 mt-2">
            We charge a transparent, flat annual management fee. There are no
            hidden costs or performance-based charges.
          </p>
        </details>
      </div>
    </section>
