...
import type { TransactionInit } from "./withdrawal-form.vue";
...
const createTransaction = async () => {
  ...
  try {
    const data = await $fetch("/api/user/transactions/withdrawal", {
      method: "POST",
      body: transaction,
    });
    toast.add({
...
<template>
  <div class="cursor-pointer" @click="createTransaction">
    <slot>
